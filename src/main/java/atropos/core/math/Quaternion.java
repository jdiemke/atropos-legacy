 ...
 * @see http://www.gamedev.net/page/resources/_/technical/math-and-physics/quaternion-powers-r1095
 ...
 * @see http://code.google.com/p/jmonkeyengine/source/browse/branches/jme3/src/core/com/jme3/math/Quaternion.java?r=6560
...
public class Quaternion {
	...
	public Matrix4f toMatrix() {
		return new Matrix4f(1.0f - 2.0f*y*y - 2.0f*z*z,        2.0f*x*y - 2.0f*w*z,        2.0f*x*z + 2.0f*w*y, 0.0f,
	...
	public Quaternion slerp2(Quaternion qb, double t) {
		...
		if (Math.abs(cosHalfTheta) >= 1.0){
			qm.w = this.w;qm.x = this.x;qm.y = this.y;qm.z = this.z;
			return qm;
		}
