...
public class CollisionDemoRenderer extends AtroposDefaultRenderer {

	
	Circle c1, c2,c3,c4;
	LineSegment l1, l2, l3, l4,test;
	Vector2f velocity = new Vector2f(3,1).multiply(0.5f);
	...
	//	gl.glEnable(GL2.GL_LIGHT0);
		...
		geometry =  new Vector<LineSegment>();
		geometry.add(l1);
		geometry.add(l2);
		geometry.add(l3);
		geometry.add(l4);
	...
	public void display(GLAutoDrawable drawable) {
		...
		Vector2f Intersection = ray.getIntersectionPoint(l2).collisionPoint;
