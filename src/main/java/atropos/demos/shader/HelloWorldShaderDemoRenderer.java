...
public class HelloWorldShaderDemoRenderer extends AtroposDefaultRenderer {
	...
	public void init(GLAutoDrawable drawable) {
		...
		vs.setShaderSource(gl, new ShaderSource(new File("shaders/helloWorldShader.vs")));
		vs.compileShader(gl);
		System.err.println(vs.getInfoLog(gl));

		FragmentShader fs = new FragmentShader(gl);
		fs.setShaderSource(gl, new ShaderSource(new File("shaders/helloWorldShader.fs")));
		fs.compileShader(gl);
	...
	public void display(GLAutoDrawable drawable) {
		...
		gl.glBegin(GL2.GL_TRIANGLES);		    
			//colorVertexAttrib4f.set(gl, 1.0f, 0.0f, 0.0f, 1.0f);
			gl.glVertex3f(0.0f, 1.0f, 0.0f);
			//colorVertexAttrib4f.set(gl, 0.0f, 1.0f, 0.0f, 1.0f);
			gl.glVertex3f(-1.0f, -1.0f, 0.0f);
			//colorVertexAttrib4f.set(gl, 0.0f, 0.0f, 1.0f, 1.0f);
			gl.glVertex3f(1.0f, -1.0f, 0.0f);
		gl.glEnd();
		...
		gl.glBegin(GL2.GL_QUADS);
			//colorVertexAttrib4f.set(gl, 1.0f, 0.6f, 0.0f, 1.0f);
			gl.glVertex3f(-1.0f, 1.0f, 0.0f);
			gl.glVertex3f(1.0f, 1.0f, 0.0f);
			gl.glVertex3f(1.0f, -1.0f, 0.0f);
			gl.glVertex3f(-1.0f, -1.0f, 0.0f);
